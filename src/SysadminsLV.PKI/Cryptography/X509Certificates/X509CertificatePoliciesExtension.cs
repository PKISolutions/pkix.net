...
public sealed class X509CertificatePoliciesExtension : X509Extension {
    static readonly Oid _oid = new(X509ExtensionOid.CertificatePolicies);
    readonly X509CertificatePolicyCollection _policies = new();

    X509CertificatePoliciesExtension(Byte[] rawData, Boolean critical) : base(_oid, rawData, critical) {
        if (rawData == null) {
    ...
    /// </summary>
    public X509CertificatePoliciesExtension() { Oid = _oid; }
    /// <summary>
    ...
    /// extension value.
    /// </remarks>
    public X509CertificatePoliciesExtension(AsnEncodedData policies, Boolean critical) : this(policies.RawData, critical) { }
    /// <summary>
    ...
    /// <param name="critical"><strong>True</strong> if the extension is critical; otherwise, <strong>False</strong>.</param>
    /// <exception cref="ArgumentNullException"><strong>policies</strong> parameter is either null or empty.</exception>
    ...
    /// </summary>
    public X509CertificatePolicyCollection Policies => new(_policies);
