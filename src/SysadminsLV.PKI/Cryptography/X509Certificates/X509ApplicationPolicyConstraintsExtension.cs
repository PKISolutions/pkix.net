...
public sealed class X509ApplicationPolicyConstraintsExtension : X509Extension {
    static readonly Oid _oid = new(X509ExtensionOid.ApplicationPolicyConstraints);
    ...
    /// <summary>
    /// Initializes a new instance of the <strong>X509ApplicationPolicyConstraintsExtension</strong> class from
    /// a minimum and maximum number of certificates with required application policy.
    /// </summary>
    ...
    /// </exception>
    public X509ApplicationPolicyConstraintsExtension(Int32? explicitPolicy, Int32? inhibitPolicy) {
