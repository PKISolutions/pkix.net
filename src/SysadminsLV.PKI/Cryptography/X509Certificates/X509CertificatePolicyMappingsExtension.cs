...
public sealed class X509CertificatePolicyMappingsExtension : X509Extension {
    static readonly Oid _oid = new(X509ExtensionOid.CertificatePolicyMappings);
    ...
    /// </exception>
    public X509CertificatePolicyMappingsExtension(AsnEncodedData mappings) : base(_oid, mappings.RawData, true) {
        if (mappings == null) {
