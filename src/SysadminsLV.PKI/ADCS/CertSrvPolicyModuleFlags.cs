...
public enum CertSrvPolicyModuleFlags {
    ...
    /// contains one or more extensions from this list, extensions will be discarded.
    /// <para>This flag is enabled by default on both Standalone and Enterprise CAs.</para>
    /// </summary>
    ...
    /// <para>Note: Do not enable this flag on Enterprise CAs. Instead, include SAN extension directly in the request.</para>
    /// <para>This flag is not enabled by default.</para>
    /// </summary>
