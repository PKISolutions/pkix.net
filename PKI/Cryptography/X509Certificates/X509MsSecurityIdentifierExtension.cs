...
namespace SysadminsLV.PKI.Cryptography.X509Certificates {
    ...
    /// </summary>
    public sealed class X509MsSecurityIdentifierExtension : X509Extension {
        static readonly Oid _oid = new Oid(X509ExtensionOid.MsftSecurityIdentifier, "Microsoft Security Identifier");

        /// <summary>
        ///     Initializes a new instance of the <strong>X509MsSecurityIdentifierExtension</strong> class from
        ...
        /// </exception>
        public X509MsSecurityIdentifierExtension(SecurityIdentifier sid, Boolean critical) {
            if (sid == null) {
        ...
        public X509MsSecurityIdentifierExtension(AsnEncodedData extensionValue, Boolean critical)
